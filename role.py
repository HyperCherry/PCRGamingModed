...
EFFECT_BRAMBLE = "life_bramble"  # 荆棘效果，与生命偷取使用方法一致
# 需要EFFECT_HURT作为前置	↑
...
ROLE = {
        ...
        "active_skills": [
            {
                ...
                "effect": {
                    EFFECT_ATTR_CHANGE: [
                        (BuffType.NormalAttrAtkUp, 30, 1),
                    ],
                }
            },
            {
                "name": "秘杖·微粒模式",
                "text": "对目标造成100（+0.8自身攻击力)伤害，并锁定一个回合",
                "tp_cost": 60,
                "trigger": TRIGGER_SELECT_EXCEPT_ME,
                "passive": [],
            ...
            {
                "name": "秘杖·反重力模式",
                "text": "对除自身以外的所有玩家造成100(+2.5自身攻击力伤害)",
                "tp_cost": 100,
                "trigger": TRIGGER_ALL,
                "passive": [],

                "effect": {
                    EFFECT_HURT: (100, Attr.ATTACK, 0, 2.5, False),
                }
            }
        ],
        "passive_skills": [],
    ...
    6506: {
        ...
        "active_skills": [
            {
                "name": "紧身绷蛋裤",
                "text": "钦爷的紧身裤有着更敏捷的活动能力，但是容易扯蛋钦爷向玩家前进5格\n" +
                        "增加自身30攻击力，损失70生命值",
                "tp_cost": 0,
                "trigger": TRIGGER_SELECT_EXCEPT_ME,
                "passive": [0, 2],
                "effect": {
                    EFFECT_HURT: (1, 0, 0, 1.0, False),
                },
            },
            {
                "name": "劳资没醉",
                "text": "钦爷千杯不醉，与别人一起喝酒不会倒下钦爷对一名玩家造成100（+1.0攻击力）伤害，\n" +
                        "自己承受该次伤害的20%",
                "tp_cost": 30,
                "trigger": TRIGGER_SELECT_EXCEPT_ME,
                "passive": [],
                "effect": {
                    EFFECT_HURT: (100, Attr.ATTACK, 0, 1.0, False),  # 造成伤害
                    EFFECT_BRAMBLE: 0.2,
                },
            },
            {
                "name": "晴天",
                "text": "钦爷弹奏晴天回复自身200（+1.3攻击力）生命值，增加20%暴击率",
                "tp_cost": 40,
                "trigger": TRIGGER_ME,
                "passive": [],
                "effect": {
                    EFFECT_ATTR_CHANGE: [
                        (Attr.NOW_HEALTH, 200, Attr.ATTACK, 1.3),
                        (Attr.CRIT, 20, 0, 0)],  # 提高暴击率
                }
            },
            {
                "name": "疾风亦有归途",
                "text": "钦爷化身亚索，E往无前,自身暴击率翻倍，攻击力+100，攻击距离延长至15",
                "tp_cost": 70,
                "trigger": TRIGGER_ME,
                "passive": [],
                "effect": {
                    EFFECT_ATTR_CHANGE: [
                        (Attr.CRIT, 1, Attr.CRIT, 1),  # 提高暴击率
                        (Attr.ATTACK, 100, 0, 0),  # 增加自身30攻击力
                        (Attr.DISTANCE, 15, 0, 0)],  # 增加攻击距离
                }
            }
        ],  # active
        "passive_skills": [
            ...
            },
            {
                "trigger": TRIGGER_ME,
                "effect": {
                    EFFECT_HURT: (0.2, Attr.ATTACK, 0, 1.0, False),  # 造成伤害
                }
            },
            {
                "trigger": TRIGGER_ME,
                "effect": {
                    EFFECT_ATTR_CHANGE: [
                        (Attr.NOW_HEALTH, -70, 0, 0),  # 恢复生命值
                        (Attr.ATTACK, 30, 0, 0)],  # 提高暴击率
                }
            },
        ],
    },
        ...
        "active_skills": [
            {
                ...
                "passive": [],
                "effect": {
                    EFFECT_BUFF: [(BuffType.TurnDougettea, 1, 3)],
                },
            },
            {
                "name": "情感大师",
                "text": "优秀的情感大师永不破防\n" +
                        "增加自身50（+20×奶茶数量）防御力，获得一个奶茶",
                "tp_cost": 10,
                "trigger": TRIGGER_ME,
                "passive": [],
                "effect": {
                    EFFECT_ATTR_CHANGE: [(Attr.DEFENSIVE, 50, Attr.SPECIAL_POINT_TEA, 20),
                                         (Attr.SPECIAL_POINT_TEA, 1, 0, 0)],
                },
            },
            {
                "name": "二次元恶心死了",
                "text": "窦老师给二次元灌入奶茶\n" +
                        "消耗一个“奶茶”对一名角色造成70(+50×剩余奶茶数伤害)",
                "tp_cost": 40,
                "trigger": TRIGGER_ME,
                "passive": [1],
                "effect": {
                    EFFECT_ATTR_CHANGE: [(Attr.SPECIAL_POINT_TEA, -1, 0, 0)],
                },
            },
            {
                "name": "幽冥之柜",
                "text": "将其他所有角色关入柜子里\n" +
                        "对所有其他角色造成10（+100×“奶茶”）数量，清空所有奶茶",
                "tp_cost": 80,
                "trigger": TRIGGER_ME,
                "passive": [0],
                "effect": {
                    EFFECT_ATTR_CHANGE: [(Attr.SPECIAL_POINT_TEA, -1, Attr.SPECIAL_POINT_TEA, 1)],
                }
            }
        ],  # active
        "passive_skills": [
            {
                "trigger": TRIGGER_ALL_EXCEPT_ME,
                "effect": {
                    EFFECT_HURT: (10, Attr.SPECIAL_POINT_TEA, 0, 100, False),  # 造成伤害
                }
            },
            {
                "trigger": TRIGGER_ALL_EXCEPT_ME,
                "effect": {
                    EFFECT_HURT: (70, Attr.SPECIAL_POINT_TEA, 0, 50, False),  # 造成伤害
                }
            }
        ],
    }
